...
document.addEventListener('DOMContentLoaded', function () {
	...
	function typeWord() {
		if (charIndex < words[wordIndex].length) {
			...
			setTimeout(eraseWord, delayBetweenWords); // Wait before erasing
		}
	}
	...
	function eraseWord() {
		if (charIndex > 0) {
			...
			charIndex--;
			setTimeout(eraseWord, typingSpeed / 2); // Erase faster
		} else {
	...
	setTimeout(typeWord, delayBetweenWords); // Start typing
});