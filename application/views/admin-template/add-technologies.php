 ...
 <div id="page-wrapper">
     <div class="row">
         <div class="col-lg-12">
             <h1 class="page-header">Add Technologies <?php echo anchor("administrator/managetechnologies", "Manage Technlogies", array("class" => "btn btn-warning pull-right")); ?></h1>
                         ...
                         <div class="col-lg-12">
                             ...
                             <?php
                                if ($this->uri->segment(3) > 0) {
                                    ...
                                    $action = "administrator/addtech";
                                }
                                echo form_open_multipart("administrator/addtech") ?>
