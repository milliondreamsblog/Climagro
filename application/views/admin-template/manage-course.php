   ...
   <div class="row">
     <div class="col-lg-12">
       <h1 class="page-header">Manage Services
         ...
         <?php echo anchor("administrator/courseform", "Add Services", array("class" => "btn btn-primary pull-right")); ?>
             ...
             <tbody>
               <?php $sn = 0;
                foreach ($pagelist as $pagedetail) {
                  ...
                  $file = read_file("./assest/uploadfile/webimages/" . $pagedetail->page_image);
                  ...
                  $cordata = $this->adminmodel->productlist($pagedetail->parent_id, "id", "tbl_course_category");
                 ...
                 <tr class="odd">
                   ...
                   <td class="center">
                     <?php
                      ...
                      echo anchor("administrator/productstatus/" . $pagedetail->id . "/id/pages/" . $pagedetail->status . "/managecourse", $pagedetail->status, array("class" => $cls)); ?>
                   ...
                   <td class="center">
                     <?php
                      ...
                      echo anchor("administrator/courseform/" . $pagedetail->id, "<i class='fa fa-pencil'></i>", array('class' => "btn btn-info btn-circle"));

                      echo " &nbsp; ";


                      echo anchor("administrator/deleteproduct/" . $pagedetail->id . "/id/pages/assest-uploadfile-webimages-" . $pagedetail->page_image . "/managecourse", "<i class='fa fa-times'></i>", array("class" => "btn btn-danger btn-circle", "onclick" => "return confirm('Do you want delete this record')"));
