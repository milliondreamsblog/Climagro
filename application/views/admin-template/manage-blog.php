   ...
   <div class="row">
     <div class="col-lg-12">
       <h1 class="page-header">Manage Blog
         ...
         <?php echo anchor("administrator/blogform", "Add Blog", array("class" => "btn btn-primary pull-right")); ?>
             ...
             <tbody>
               <?php $sn = 0;
                foreach ($pagelist as $pagedetail) {
                  ...
                  $file = read_file("./assest/uploadfile/blogimages/" . $pagedetail->page_image);
                ...
                ?>
                 <tr class="odd">
                   <td><?php echo $sn; ?></td>
                   <td><img src="../assest/uploadfile/blogimages/<?php echo $image; ?>" style="width: 100px;"></td>
                   ...
                   <td class="center">
                     <?php
                      ...
                      echo anchor("administrator/productstatus/" . $pagedetail->id . "/id/blog/" . $pagedetail->status . "/manageblog", $pagedetail->status, array("class" => $cls)); ?>
                   ...
                   <td class="center">
                     <?php
                      ...
                      echo anchor("administrator/blogform/" . $pagedetail->id, "<i class='fa fa-pencil'></i>", array('class' => "btn btn-info btn-circle"));

                      echo " &nbsp; ";


                      echo anchor("administrator/deleteproduct/" . $pagedetail->id . "/id/blog/assest-uploadfile-blogimages-" . $pagedetail->page_image . "/manageblog", "<i class='fa fa-times'></i>", array("class" => "btn btn-danger btn-circle", "onclick" => "return confirm('Do you want delete this record')"));
