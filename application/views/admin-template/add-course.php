 ...
 <div id="page-wrapper">
     <div class="row">
         <div class="col-lg-12">
             <h1 class="page-header">Add Services<?php echo anchor("administrator/managecourse", "Manage Services", array("class" => "btn btn-warning pull-right")); ?></h1>
                         ...
                         <div class="col-lg-12">
                             ...
                             <?php if ($this->session->userdata("sucprofile")) { ?><div class="alert alert-success"><?php echo $this->session->userdata("sucprofile"); ?></div><?php }
                                                                                                                                                                        ...
                                                                                                                                                                        $this->session->unset_userdata("sucprofile");
                                                                                                                                                                            ?>
                             <?php
                                echo form_open_multipart("administrator/addcourse") ?>
                             ...
                             <div class="form-group">
                                 ...
                                 <?php echo form_input(array('class' => 'form-control', 'placeholder' => 'Enter number of service', 'name' => 'serialnum', 'value' => set_value('serialnum', @$servicedata->page_short)));
                                    ?>
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <select name="type" class="form-control" required="">
                                     ...
                                     <option value="0" <?php echo $course; ?>>Service Page</option>
                                 </select>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <?php
                                    ...
                                    if (@$servicedata->id > 0) {
                                        ...
                                        if (read_file(base_url() . "assest/uploadfile/webimages/" . $servicedata->page_image) && $servicedata->page_image != '') {
